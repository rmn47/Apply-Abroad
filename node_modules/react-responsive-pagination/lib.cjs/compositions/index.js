    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (current === null)
                    return [2 /*return*/];
                leftRanges = (0, ranges_1.narrowToWideRanges)(1, current - 1, 'left');
                rightRanges = (0, ranges_1.narrowToWideRanges)(current + 1, total, 'right');
...
function activePage(current) {
    return (0, paginationItem_1.createPageItem)(current, true);
}
function navPrevious(current) {
    return (0, paginationItem_1.createNavItem)('previous', current > 1 ? current - 1 : undefined);
}
function navNext(current, total) {
    return (0, paginationItem_1.createNavItem)('next', current < total ? current + 1 : undefined);
}
