            ...
            <nav className="bg-white border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="hidden sm:flex sm:items-center sm:ml-6">
                            <div className="shrink-0 flex items-center">
                                <Link href="/">
                                    <ApplicationLogo className="h-14 md:mt-1 w-auto text-gray-500" />
                                </Link>
                            </div>
                            ...
                            <div className="space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink
                                    ...
                                    active={route().current("quick_search")}
                                >
                                    Programs &amp; Schools
                                </NavLink>
                                <NavLink
                ...
                >
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('quick_search')} active={route().current('quick_search')}>
                            Programs &amp; Schools
                        </ResponsiveNavLink>
